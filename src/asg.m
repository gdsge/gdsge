classdef asg <  handle
    ...
    methods
        ...
        function reset(this)
            % RESET()
            % Clear all grids/surplus but keep allocated capacity, so this object
            % can be rebuilt in place (ping-pong reuse across iterations) instead
            % of being deleted and freshly allocated.
            assert_not_empty(this);
            asg_mex('reset',this.objectHandle);
        end
